...
export class BookAuthorsResolver {
  ...
  @Mutation(() => BookAuthor)
  createBookAuthor(@Args('createBookAuthorInput') createBookAuthorInput: CreateBookAuthorInput) {
  ...
  @Mutation(() => BookAuthor)
  updateBookAuthor(@Args('updateBookAuthorInput') updateBookAuthorInput: UpdateBookAuthorInput) {
    return this.bookAuthorsService.update(updateBookAuthorInput.id, updateBookAuthorInput);
  }
